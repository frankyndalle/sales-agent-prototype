...
1. Three-Agent Prompt Chaining Architecture:
   ...
   - Research & Competitor Intelligence Agent: Performs live web scraping via BeautifulSoup and strictly grounds its analysis in real retrieved web evidence.
...
Run the class uv workflow to sync your project environment:
uv sync

### 3. Launch the Streamlit Application
Start your web application locally using uv:
